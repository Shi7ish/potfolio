          ...
          <div className='flex flex-col gap-20 md:flex-row md:gap-47.5'>
            ...
            <div className='flex flex-col gap-10'>
              <div className='flex flex-col gap-5'>
                <input type="text" placeholder='Name' className='w-full py-[21px] px-7.5 bg-[#F3F3F3] placeholder:text-[#2D2D2D] items-start md:w-[530px]' />
                <input type="text" placeholder='Email' className='w-full py-[21px] px-7.5 bg-[#F3F3F3] placeholder:text-[#2D2D2D] items-start md:w-[530px]' />
                <textarea name="" id="" placeholder='Type your message here' className='w-full py-[21px] px-7.5 bg-[#F3F3F3] placeholder:text-[#2D2D2D] h-58 items-start md:w-[530px] '></textarea>
              </div>
